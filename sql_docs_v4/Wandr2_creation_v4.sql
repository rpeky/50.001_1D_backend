CREATE DATABASE  IF NOT EXISTS `wandr2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `wandr2`;
...
INSERT INTO `cart` VALUES (1,1),(2,11),(3,13),(4,16),(5,17);
...
INSERT INTO `comments` VALUES (5,17,NULL,14,'Tried to go to Rome, was very expensive, Idt  this person is saying the truth at all.','2025-04-11 17:19:47','2025-04-11 17:19:47'),(6,17,NULL,12,'Trip to your mom is very rude, who tf made this','2025-04-11 17:20:54','2025-04-11 17:20:54'),(11,17,17,NULL,'What a aonderful activity','2025-04-13 15:46:47','2025-04-13 15:46:47');
...
INSERT INTO `product_reviews` VALUES (2,1,1,4,'Actually, the battery life could be better.',1),(4,17,3,5,'Long term review update. These are still holding up great!',1);
...
INSERT INTO `products` VALUES (1,'Portable Bluetooth Speaker','Electronics',29.99,45,5),(2,'Notebook','Stationery',7.9,180,0),(3,'Backpack','Bags',32,296,4);
...
INSERT INTO `purchase_history` VALUES (1,1,1,5,149.95,'2025-04-13 15:40:58'),(2,17,3,2,64,'2025-04-13 17:49:46');
...
-- Dump completed on 2025-04-14  2:13:56
